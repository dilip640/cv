...
\begin{tabular}{ l @{\hskip 0.006cm} l }
    ...
    \textbf{Frameworks / Libraries} & Tensorflow, Beam, Qor, OpenCV, Flutter, Django, jQuery \\ 
...
\item[] Data Science Intern, \textbf{\href{https://www.xlpat.com}{XLPAT}}\\
    ...
    \begin{itemize}
        \item Implemented Zero-Shot Learning for auto-categorize patents based on user input categories and trained model on
